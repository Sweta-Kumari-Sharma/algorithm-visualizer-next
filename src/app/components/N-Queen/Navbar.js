...
const Navbar = ({
    handleChangeSpeed, speed, handleValueIncrease, number, isRunning, handleStartAlgo, handleStopAlgo,handleRefresh
}) => {
  return (
    <>
      <div className="navbar w-[100vw]  items-center justify-evenly shadow-2xl mb-4 flex" style={{padding:'30px'}}>
